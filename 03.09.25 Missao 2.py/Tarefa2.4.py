# ==========================================================================================================
# TAREFA 4:  -   Aprendizado Não Supervisionado - "Você é um analista de segurança. Sua missão é identificar 
# transações fraudulentas (anomalias) em um conjunto de dados. Uma transação anômala geralmente está muito 
# distante das outras." Use o mesmo KMeans para agrupar as transações. A transação que ficar isolada em seu 
# próprio cluster é provavelmente a anomalia.
# ===========================================================================================================
